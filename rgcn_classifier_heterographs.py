...
def main(bug_type, use_deepbugs_embeddings, dataset_size):
    ...
    model = HeteroClassifier(200, 16, trainset.num_classes, \
      ['follows', 'has_value_of', 'has_value_type', 'precedes', 'is_left_param_of', 'is_right_param_of', 'is_type_of'] if bug_type == 'swapped_args' else ['parent', 'parent', 'precedes', 'parent', 'followed_by', 'follows', 'typeOf'])
