...
with open('./token_to_vector/token_to_vector_all_tokens.json') as f:
...
trainset = CorrectAndBuggyDataset(use_deepbugs_embeddings=True, is_training=True, bug_type='swapped_args')
testset = CorrectAndBuggyDataset(use_deepbugs_embeddings=True, is_training=False, bug_type='swapped_args')
